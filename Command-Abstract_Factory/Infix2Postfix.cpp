...
//COMMENT: There is no need to have this method. Using a stringstream object will do this for you.
//Please see the sample code provided in the slides for guidance.
//RESPONSE: Okay thank you, I removed the method now
...
void Infix2Postfix::toPosfix(Expr_Command_Factory & factory, Queue<Expr_Command*> &posfixQueue){
	...
	//split infixExpression into token
